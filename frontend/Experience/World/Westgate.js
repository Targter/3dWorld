...
export default class Westgate {
    ...
    setWorld() {
        ...
        // Ensure models are properly positioned and optimized
        const models = [
            this.bars, this.brick, this.buildings, this.easter, 
            this.everything, this.floor, this.grass, this.other, 
            this.outside, this.panera, this.plastic, this.tables, 
            this.thirdfloor, this.box, this.glass, this.screen
        ];
